...
use mako\pixel\image\operations\vips\Watermark;
...
class WatermarkTest extends TestCase
{
	...
	{
		$image = Vips::create(new Dimensions(8, 8), new Color(0, 0, 0));

		$watermark = Vips::create(new Dimensions(2, 2), new Color(255, 0, 0));
